...
export default function ProjectsPreview() {
  ...
  const items = projects
    .filter((p) => ALL_PROJECT_IDS.includes(p.id))
    .sort((a, b) => ALL_PROJECT_IDS.indexOf(a.id) - ALL_PROJECT_IDS.indexOf(b.id));
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-ink/50 mb-10">What I build beyond 9-5</p>

        {/* Single carousel header */}
