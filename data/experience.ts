            ...
            initiatives: [
              {
                ...
                what: "Owned the 0-to-1 roadmap for the companion app from discovery through launch; defined MVP scope, managed product backlog, and led cross-functional alignment.",
                how: "Sequenced feature delivery for maximum learning and led cross-functional alignment across engineering and design to drive seamless ecosystem integration and early retention.",
                result: "MVP shipped on time · seamless ecosystem integration · early retention established",
              },
              {
                ...
                what: "Validated product-market fit through 100+ interviews, applying strong user empathy to synthesize qualitative insights into key user needs.",
                how: "Conducted 100+ user interviews, applied user empathy to synthesize qualitative insights into key user needs, and shaped findings into PRDs that guided feature prioritization.",
